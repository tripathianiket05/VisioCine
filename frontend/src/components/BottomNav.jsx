...
export default function BottomNav() {
  return (
    <nav className="flex justify-around items-center h-16 w-full max-w-md mx-auto md:hidden bg-surface-container/60 backdrop-blur-lg dark:bg-surface-container/60 fixed bottom-0 left-0 right-0 z-50 rounded-t-xl border-t border-white/10 shadow-[0_-4px_20px_rgba(0,0,0,0.5)]">
